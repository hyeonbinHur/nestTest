...
const repositories_json_1 = __importDefault(require("../data/repositories.json"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
let RepositoriesService = class RepositoriesService {
    repositories = Array.isArray(repositories_json_1.default)
        ? repositories_json_1.default
        : repositories_json_1.default.default || [];
    findAll() {
